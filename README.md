...
**Q9**：为何相同的图片要下载两次？  
**A9**：有些发帖者担心单一图床挂掉，一般将同个图片上传到两个不同图床上，在帖子中同时发布两个图床的不同地址，hardseed 无法图片是否相同，所以都下载。
...
* 代理服务器限制下载，禁用其他代理禁用 goagent。

**Q11**：我没指定任何忽略关键字，为什么 hardseed 强制取消下载“连发, 連发, 连發, 連發, 连弹, ★㊣, 合辑, 合集, 合輯, nike, 最新の美女骑兵㊣, 精選, 精选”这类合集帖子？  
**A11**：两方面原因。一方面，合集均是把以往的单个帖子合并一起再发布，完全重复；一方面，虽然帖子种到图片看起来对应多部片子，但实际上合集中的种子只是其中一部片子的，没有意义。

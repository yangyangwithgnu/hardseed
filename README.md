...
**2014-7-21：请各位尊重各大爱的论坛，提供的资源不仅优质而且免费。请大家支持这些网站，多用页面访问、多点击页面广告、多解囊捐赠。**我在干嘛 @_@#


##版本
----------------

[修正 v0.1.1]：2014-7-21 13:09:39，caoliu 论坛增加了反机器人机制，若翻页过快则视为机器人行为，下载页面为空白页。此版本可以应对它的反机器人机制。
...
###【翻墙】  
你知道，这一切的一切都在墙外，所以你得具备翻墙环境，hardseed 才能正常帮你拉女神。hardseed 支持 goagent、shadowsocks、SSH、VPN （PPTP 和 openVPN）等各类代理模式，甚至你可以并行使用多种代理以极速下载。从普及度、稳定性、高效性来看，goagent 最优。“我一技术小白，平时工作压力本来就大，就想看看女神轻松下，你还让我折腾代理！没人性！”，嘚，亲，我错了。我帮你配置了一份开箱即用的\ goagent，位于 hardseed/proxy/goagent/local/，linux 用户，命令行中运行
```
$ python proxy.py
```
